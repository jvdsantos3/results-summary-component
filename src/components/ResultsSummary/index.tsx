import {
  ...
  SummaryIndicatorItem,
  SummaryIndicatorItemPercent,
} from './styled'
  ...
  return (
    <ResultsSummaryContainer>
      ...
      <SummaryContainer>
        <h2>Summary</h2>
        <SummaryIndicatorContainer>
          <SummaryIndicatorItem variant="red">
            <SummaryIconTitle>
              <svg
          ...
          <SummaryIndicatorItem variant="yellow">
            <SummaryIconTitle>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          <SummaryIndicatorItem variant="green">
            <SummaryIconTitle>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          <SummaryIndicatorItem variant="blue">
            <SummaryIconTitle>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
